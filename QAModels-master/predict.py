...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default="data/datasets/SQuAD-dev-v1.1.json",
                        help='SQuAD-like dataset to evaluate on')
    parser.add_argument('--model', type=str, default="data/models/20190419-30a90d90-best-epoch_29-em_65.01-f1_74.55.mdl",
                        help='Path to model to use')
    parser.add_argument('--embedding-file', type=str, default="data/embeddings/glove.840B.300d.txt",
                        help=('Expand dictionary to use all pretrained '
                              'embeddings in this file.'))
    parser.add_argument('--char-embedding-file', type=str, default="data/embeddings/glove.840B.300d-char.txt",
                        help=('Expand dictionary to use all pretrained '
